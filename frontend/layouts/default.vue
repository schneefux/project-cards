  ...
  <div class="flex flex-col min-h-screen">
    ...
    >
      <div class="flex-shrink-0 pt-3 md:py-0 w-full md:w-auto">
        <nuxt-link to="/" class="font-bold text-xl tracking-tighter nav-link"
      ...
      <div class="menu w-full md:w-auto">
        <div
          class="overflow-x-auto overflow-y-hidden scrolling-touch whitespace-no-wrap"
        >
    ...
    <footer
      class="bg-gray-100 py-2 text-sm text-gray-600 text-center leading-normal"
    >
