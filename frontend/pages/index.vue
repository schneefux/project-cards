  ...
  <div>
    <div class="py-20 bg-gradient-r-dark-to-secondary">
      <div class="container mx-auto px-6">
        ...
        <nuxt-link to="/games" class="bg-white hover:bg-secondary-100 button--xl">Play Online</nuxt-link>
      </div>
    </div>
    ...
    <section class="container mx-auto px-6 p-10">
      ...
      <div class="feature">
        <div class="w-full md:w-1/2">
          <h4 class="feature__heading">Card Designer</h4>
          <p class="feature__text">Create Trump-style playing cards with custom images and text.</p>
        </div>
        <div class="w-full md:w-1/2">
      ...
      <div class="feature">
        ...
        <div class="w-full md:w-1/2 pl-10">
          ...
          <p class="feature__text">
            Challenge friends or strangers and play "Goofenspiel", the Game of
            Pure Strategy with cards created by you or the community.
          </p>
        </div>
      </div>
